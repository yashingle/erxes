import {
    Button, Form, ControlLabel, FormControl, FormGroup, generateCategoryOptions, mainStyles
} from 'erxes-ui-utils';
import React from 'react';
import { IButtonMutateProps, ICarCategory, IFormProps } from '../../types';

const { ModalFooter } = mainStyles
type Props = {
